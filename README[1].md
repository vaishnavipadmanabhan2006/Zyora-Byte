...
My 15-day Frontend Developer internship log at **Zyora Byte** — starting with Day 1: setting up my dev environment and shipping my first launch page.
...
- `index.html` — my Developer Launch Page: who I am, what I'm building over the next 15 days, and why I joined.
- `README.md` — this file.

## Day 1

- [x] Installed VS Code, Git, and Node.js LTS
- [x] Created this public GitHub repo
- [x] Built `index.html` (launch page)
- [x] Wrote this README
